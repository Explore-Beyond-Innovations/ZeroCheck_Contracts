...
contract EventRewardManagerTest is Test {
  ...
  function testCreateTokenRewardZeroAddress() public {
    ...
    rewardManager.createTokenReward(
      eventId, EventRewardManager.TokenType.USDC, address(0), rewardAmount, eventCreator
    );
  }
  ...
  function testCreateTokenRewardZeroAmount() public {
    ...
    rewardManager.createTokenReward(
      eventId, EventRewardManager.TokenType.USDC, address(usdcToken), 0, eventCreator
    );
  }
  ...
  function testCreateTokenRewardInvalidTokenType() public {
    ...
    rewardManager.createTokenReward(
      eventId, EventRewardManager.TokenType.NFT, address(usdcToken), rewardAmount, eventCreator
    );
  }
  ...
  function testUpdateTokenReward() public {
    ...
    rewardManager.updateTokenReward(address(eventCreator), eventId, additionalReward);
  ...
  function testUpdateTokenRewardOnlyEventManager() public {
    ...
    rewardManager.createTokenReward(
      eventId, EventRewardManager.TokenType.USDC, address(usdcToken), rewardAmount, owner
    );
    ...
    rewardManager.updateTokenReward(eventCreator, eventId, additionalReward);
  }
  ...
  function testUpdateTokenRewardEventDoesNotExist() public {
    ...
    vm.expectRevert("Event does not exist");
    rewardManager.updateTokenReward(eventCreator, invalidEventId, additionalReward);
  }
